package app.ichingoracle.plugin.plumblossom.mysteries;

import app.ichingoracle.core.MethodPlugin;
import app.ichingoracle.core.MethodPluginCallback;
import app.ichingoracle.plugin.plumblossom.mysteries.controller.Method;
...
{
    @Override
    public String getId() { return "plumblossom-mysteries"; }
